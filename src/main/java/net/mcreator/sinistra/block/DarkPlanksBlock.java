...
public class DarkPlanksBlock extends SinistraModElements.ModElement {
	@ObjectHolder("sinistra:dark_planks")
	public static final Block block = null;
	public DarkPlanksBlock(SinistraModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 2.3f).lightValue(0).harvestLevel(1)
