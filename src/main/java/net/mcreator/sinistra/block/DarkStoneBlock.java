...
public class DarkStoneBlock extends SinistraModElements.ModElement {
	@ObjectHolder("sinistra:dark_stone")
	public static final Block block = null;
	public DarkStoneBlock(SinistraModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2.3f, 8f).lightValue(0).harvestLevel(1)
