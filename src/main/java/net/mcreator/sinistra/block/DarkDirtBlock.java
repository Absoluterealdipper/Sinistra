...
public class DarkDirtBlock extends SinistraModElements.ModElement {
	@ObjectHolder("sinistra:dark_dirt")
	public static final Block block = null;
	public DarkDirtBlock(SinistraModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(0.8f, 10f).lightValue(0).harvestLevel(0)
